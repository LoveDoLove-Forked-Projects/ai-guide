...
另一个让我印象深刻的点是，Opus 5 确实像官方说的那样，特别爱自己检查作业。Anthropic 甚至专门提醒开发者把提示词里那句「最后记得验证一遍」删掉，你越叮嘱它反而越容易检查上瘾。他们后来干脆把 Claude Code 的系统提示词删掉了 80% 以上，编程跑分一点没掉。关于这套提示词减法的具体做法，可以阅读本教程经验技巧板块中的《Anthropic 官方的提示词精简方法》。
