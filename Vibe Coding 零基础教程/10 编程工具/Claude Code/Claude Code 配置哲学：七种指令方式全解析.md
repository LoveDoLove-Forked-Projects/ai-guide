...
顺便说个能佐证这套设计的事：Anthropic 自己在新模型发布后，把 Claude Code 的系统提示词砍掉了 80% 以上，而编程跑分一点没掉。他们砍掉的正是那些本该交给模型自己判断、或者本该做成按需加载的内容。想了解这套「提示词减法」的具体做法，可以阅读本教程经验技巧板块中的《Anthropic 官方的提示词精简方法》。
