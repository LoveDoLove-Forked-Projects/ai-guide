...
还有两篇是关于提示词的最新变化。《Anthropic 官方的提示词精简方法》讲的是官方为什么把 Claude Code 的系统提示词砍掉了 80% 却不影响效果，以及我们自己该怎么给规则做减法；《用 grill-me 让 AI 拷问你的需求》则介绍了一个只有几句话、但安装量排到全网前 3 的神级 Skill，教你在写代码之前先把需求想清楚。这两篇正好是一组，一个讲少写什么，一个讲怎么把该说的说清楚。
